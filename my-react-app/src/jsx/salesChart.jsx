...
const SalesChart = () => {
  ...
  return (
    <div className="chart-wrapper" style={{ display: "flex", flexDirection: "column", width: "95%", height: "100%" }}>
      {/* ✅ Custom Header */}
      <div
      ...
      {/* ✅ Chart */}
      <div className="chart-container" style={{ height: "400px", width: "100%", display:"flex", alignItems:"center", justifyContent:"center", padding: "10px"}}>
